...
bool TimeOfDay::operator == (const TimeOfDay& t2) const
{
    return (hours == t2.hours) && (minutes == t2.minutes);
}

TimeOfDay TimeOfDay::operator + (const TimeOfDay& t2) const
{
    TimeOfDay tsum(hours + t2.hours, minutes + t2.minutes);
    return tsum;
}
...
TimeOfDay TimeOfDay::operator - (const TimeOfDay& t2) const
{
    TimeOfDay tsub(hours - t2.hours, minutes - t2.minutes);
    return tsub;
}
